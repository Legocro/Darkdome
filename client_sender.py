...
if __name__ == "__main__":
    ...
    try:
        somenumber = 1+1
        client2.join_room("b1efcd3e-a9ed-4a4a-bdbd-1169c092a0f9") #REPLACE WITH ROOM ID AFTER RUNNING CLIENT_RECIEVER.py
    ...
    while True:
        ...
        #client1.send({"name": "Marin",
        #              "message": input("Your message goes here > ")})
        client2.send({"name": "Ivan", #Any name
                        "message": input("Your message goes here > ")})
        #client3.send({"name": "Petar",
        #              "message": input("Your message goes here > ")})
